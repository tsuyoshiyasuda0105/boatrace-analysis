...
set "BOATRACE_TASK_TRIGGER=render-prewarm"
call :run_step "prewarm_strategy_pages_before_predictions" ".venv\Scripts\python.exe" "scripts\prewarm_strategy_pages.py" "--mode" "morning-check"
call :run_step "cache_predictions" ".venv\Scripts\python.exe" "scripts\cache_predictions.py" "--today"
